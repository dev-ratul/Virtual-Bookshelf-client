          ...
          <div key={idx}>
            ...
            >
              ...
              <div className="relative z-10 text-white text-center px-4 sm:px-10 max-w-4xl animate__animated animate__fadeIn">
                ...
                <Link to={slide.link}>
                  <button className="px-8 py-3 cursor-pointer bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-indigo-600 hover:to-purple-600 text-white text-lg font-semibold rounded-full transition-all duration-300 shadow-xl hover:scale-105">
                    {slide.btnText}
                  </button>
                </Link>
              </div>
